...
| UI and frontend shell | PARTIAL | `base-ui.js`, `ux-cn-v11.js`, and `regression-v14.js` provide the current in-game UI. | Does not define account, lobby, settings, or social architecture. | Phase 1 creates a coherent start/lobby/settings/game-HUD shell without changing gameplay rules. |
